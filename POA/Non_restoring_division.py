# Dhvani Thakkar C1-2 C046 60004220038
...
# Main function to perform non restoring division according to the flowchart
# Accepts dividend in q and divisor in m and returns quotient and remainder (all unsigned binary numbers in list(int))
...
quo, rem = non_restoring_division(bool_q, bool_m)
